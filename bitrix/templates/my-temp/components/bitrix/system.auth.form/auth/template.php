...
<img src="<?=SITE_TEMPLATE_PATH?>/images/punkt_top.gif" width="10" height="11" border="0" alt="">&nbsp;&nbsp;<a href="<?=$arResult["AUTH_REGISTER_URL"]?>" onclick="return ShowLoginForm();"><?=GetMessage("AUTH_LOGIN_BUTTON")?></a>&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?=SITE_TEMPLATE_PATH?>/images/punkt_top.gif" width="8" height="11" border="0" alt="">&nbsp;&nbsp;<a href="<?=$arResult["AUTH_REGISTER_URL"]?>"><?=GetMessage("AUTH_REGISTER")?></a>
